...
var _renderLink = function _renderLink(linkText, linkUrl) {
  return !linkUrl ? null : _react2.default.createElement(
    ...
    { noWrap: true, __self: undefined
    },
    _react2.default.createElement(
      _link2.default,
      { className: "ModuleTitle-link", href: linkUrl, __self: undefined
      },
      linkText,
      _react2.default.createElement(_icon2.default, { name: "angle-right", className: "ModuleTitle-icon", __self: undefined
      })
    )
  );
};
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "h5",
          { className: "ModuleTitle-heading", __self: undefined
          },
          title
        )
      ),
