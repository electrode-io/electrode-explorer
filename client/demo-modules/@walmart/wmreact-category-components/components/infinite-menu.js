...
var InfiniteMenu = function (_Component) {
  ...
  InfiniteMenu.prototype._renderLink = function _renderLink(item, index, linkId) {
    ...
    return _react2.default.createElement(
      "li",
      { key: index, className: classNames, __self: this
      },
      _react2.default.createElement(
        "a",
        { href: item.url, title: item.linkText, __self: this
        },
        item.linkText
      )
    );
  ...
  InfiniteMenu.prototype._renderMenu = function _renderMenu() {
    ...
    return _react2.default.createElement(
      "ul",
      { className: "InfiniteMenu-List", ref: "menuList", style: style, __self: this
      },
