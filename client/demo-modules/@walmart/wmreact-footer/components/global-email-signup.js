...
var _globalEmailSignupModal = require("./global-email-signup-modal");
...
var GlobalEmailSignup = function (_Component) {
  ...
  GlobalEmailSignup.prototype._renderFooterItem = function _renderFooterItem(_ref4) {
    var moduleData = _ref4.moduleData;
    var autoId = _ref4.autoId;
    var link = moduleData.configs.link;

    var linkSuffix = "link";
    return _react2.default.createElement(_globalFooterItem2.default, {
