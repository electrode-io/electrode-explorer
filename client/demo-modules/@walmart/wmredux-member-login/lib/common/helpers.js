...
exports.getResetPasswordEmail = exports.handleResponse = exports.validateForm = exports.getTouchedErrors = exports.getEmailFromForgotEmailResponse = exports.getDefaultEmail = undefined;
...
var getDefaultEmail = exports.getDefaultEmail = function getDefaultEmail(state) {
  ...
  var transientState = state.signIn && state.signIn.tempForm && state.signIn.tempForm.email;

  return transientState || defaultState;
};
var getEmailFromForgotEmailResponse = exports.getEmailFromForgotEmailResponse = function getEmailFromForgotEmailResponse(state) {
  var defaultState = state.customer && state.customer.email;
  var transientState = state.forgotEmail && state.forgotEmail.email;
  return transientState || defaultState;
};
...
var getResetPasswordEmail = exports.getResetPasswordEmail = function getResetPasswordEmail(state) {
  var defaultState = state.resetPassword && state.resetPassword.email;
  return defaultState || "";
};