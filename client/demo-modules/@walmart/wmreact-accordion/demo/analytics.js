...
var Analytics = function (_React$Component) {
  ...
  Analytics.prototype.render = function render() {
    return _react2.default.createElement(_wmreactAnalytics.AnalyticsProvider, { onEvent: this.processEvent }, _react2.default.createElement(_wmreactAnalytics.CollectorContext, { productId: 2020 }, _react2.default.createElement("div", { className: "component-documentation" }, _react2.default.createElement(_index2.default, null, _react2.default.createElement(_index2.default.Item, { title: "Step 1" }, _react2.default.createElement("h1", null, "First Step Content")), _react2.default.createElement(_index2.default.Item, { title: "Step 2" }, _react2.default.createElement("h1", null, "Second Step Content")), _react2.default.createElement(_index2.default.Item, { title: "Step 3" }, _react2.default.createElement("h1", null, "Third Step Content"))), _react2.default.createElement("h4", null, "Events"), this.state.events.map(function (evt, index) {
