...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    onChange: function onChange(id) {
      return dispatch((0, _facetTab.onFacetTabChange)(ownProps.moduleId, parseInt(id, 10)));
    },
    onLoad: function onLoad() {
      return dispatch((0, _facetTab.onFacetTabLoad)(ownProps.moduleId));
    }
  };
};
...
var FacetTabWrapper = function (_React$Component) {
  ...
  FacetTabWrapper.prototype.render = function render() {
    return _react2.default.createElement(_wmreactCategoryComponents2.default.FacetTab, this.props);
  };
