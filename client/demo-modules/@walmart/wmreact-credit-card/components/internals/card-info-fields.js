...
var CardInfoFields = function (_React$Component2) {
  ...
  CardInfoFields.prototype.value = function value() {
    ...
    return (0, _keys2.default)(this.activeFields()).map(function (key) {
      ...
      var value = _this5.state[field.props.name] === undefined ? field.getValue() : _this5.state[field.props.name];
  ...
  CardInfoFields.prototype._creditCard = function _creditCard() {
    ...
    var validate = function validate(value) {
      ...
      if (/^6032202[05]\d*/.test(value)) {
        if (_this6.state.errorLabelToken !== "notAccepted") {
          _this6.setState({ errorLabelToken: "notAccepted" });
        }
        return false;
      }

      if (!new _creditCard3.default(value).isValid()) {
        if (_this6.state.errorLabelToken !== "error") {
          _this6.setState({ errorLabelToken: "error" });
        }
        return false;
      }
    ...
    var handleChange = function handleChange(ev) {
      ...
      _this6.setState({ creditCard: newValue, cardType: _this6._getCardType(newValue) });

      if (lastFour && cardNumberEditable) {
        if (_this6.creditCardValueIsDefaultOrEmpty(newValue)) {
          if (editingCardNumber) {
          ...
          _this6.setState({ editingCardNumber: true });
        }
      }
    };
    ...
    var handleFocus = function handleFocus(event) {
      ...
      if (lastFour) {
        if (_this6.creditCardValueIsDefaultOrEmpty(_this6.state.creditCard)) {
          _this6.setState({ creditCard: _this6.editingCreditCardValue() });
    ...
    var handleBlur = function handleBlur() {
      var field = _this6.fields.creditCard.refs["credit-card-number-field"];
      if (lastFour) {
        if (_this6.creditCardValueIsDefaultOrEmpty(_this6.state.creditCard)) {
          _this6.setState({ creditCard: _this6.defaultCreditCardValue(_this6.props) });
          (0, _defer2.default)(function () {
    ...
    return _react2.default.createElement(_validatedField2.default, {
      ...
      ref: function ref(elem) {
        return _this6.fields.creditCard = elem;
      },
      name: "creditCard",
      autoComplete: "off",
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_validatedField2.default, {
        ...
        ref: function ref(cvv) {
          return _this7.fields.cvv = cvv;
        },
        onChange: function onChange(ev) {
          return _this7.setState({ cvv: ev.target.value });
        },
        ...
        onClick: function onClick() {
          return _this7.cvvFlyout && _this7.cvvFlyout.close();
        }
      })
    );
  };
  ...
  CardInfoFields.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_validatedField2.default, {
        ...
        ref: function ref(elem) {
          return _this8.fields.firstName = elem;
        },
        name: "firstName",
        autoComplete: "given-name",
        onChange: function onChange(ev) {
          return _this8.setState({ firstName: ev.target.value });
        },
        maxLength: "25",
      ...
      _react2.default.createElement(_validatedField2.default, {
        ...
        onChange: function onChange(ev) {
          return _this8.setState({ lastName: ev.target.value });
        },
        ref: function ref(elem) {
          return _this8.fields.lastName = elem;
        },
        name: "lastName",
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_expirationDateChooser2.default, {
            ...
            ref: function ref(elem) {
              return _this8.fields.expirationDate = elem;
            },
      ...
      _react2.default.createElement(_validatedField2.default, (_React$createElement = {
        ...
        onChange: function onChange(ev) {
          return _this8.setState({ phone: ev.target.value });
        },
        ref: function ref(elem) {
          return _this8.fields.phone = elem;
        },
        name: "phone",
