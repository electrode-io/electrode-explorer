...
var VerticalItemCarouselCurated = function VerticalItemCarouselCurated(props) {
  return _react2.default.createElement(_tempoTileCarousel2.default, (0, _extends3.default)({ className: "VerticalItemCarouselCurated" }, props, { vertical: true }));
};

VerticalItemCarouselCurated.propTypes = {
  /**
...
VerticalItemCarouselCurated.defaultProps = {
  userLoggedIn: false,
...
exports.default = VerticalItemCarouselCurated;