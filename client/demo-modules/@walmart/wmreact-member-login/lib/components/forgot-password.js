...
var ForgotPassword = function (_React$Component) {
  ...
  ForgotPassword.prototype._renderVerificationLink = function _renderVerificationLink() {
    ...
    var onPreResetPassword = _props.onPreResetPassword;
    ...
    return _react2.default.createElement(
      "p",
      {
        className: (0, _classnames2.default)("verification-code-wrapper") },
      _react2.default.createElement(
        _button2.default,
        {
          fakelink: true,
          onClick: function onClick() {
            return onPreResetPassword(email.value);
          },
...
ForgotPassword.propTypes = {
  ...
  onPreResetPassword: _react.PropTypes.func.isRequired
};
