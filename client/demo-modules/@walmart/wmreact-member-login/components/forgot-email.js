...
var ForgotEmail = function (_React$Component) {
  _inherits(ForgotEmail, _React$Component);

  function ForgotEmail(props) {
    _classCallCheck(this, ForgotEmail);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ForgotEmail).call(this, props));

    _this.state = { show: "show-hide-flyout" };
    return _this;
  }

  _createClass(ForgotEmail, [{
    key: "_toggle",
