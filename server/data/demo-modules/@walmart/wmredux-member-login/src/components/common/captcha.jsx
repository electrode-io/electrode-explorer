...
import * as actionTypes from "../../actions/constants/captcha";

const IS_BOT = "cf_is_bot";
...
export default (options) => (Component) => {
  ...
  class CaptchaEnabledComponent extends React.Component {
    ...
    _onSubmit(data = {}, apiProp) {
      ...
      const cfCorrelationId = this._cfCorrelationId;
      const captcha = {sensorData, reCaptcha, cfCorrelationId};
