...
exports.default = {
  ...
  lostStolenMembership: function lostStolenMembership(data) {
    return (0, _fetch2.default)(_config2.default.lostStolenUrl, {
      membershipNumber: data.membershipNumber.trim()
    });
  },
  onMultipleEmail: function onMultipleEmail(data) {
    return (0, _fetch2.default)(_config2.default.multipleEmailUrl, {
      email: data.email.trim()
    });
  }
};