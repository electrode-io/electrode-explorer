...
var findNextSlideClicks = function findNextSlideClicks(canary) {
  var sequence = (0, _canaryEventSequence2.default)(canary.event, [_canaryEventPattern2.default.label("nextSlide").match({ _type: "nextSlide" })]);
...
exports.default = findNextSlideClicks;