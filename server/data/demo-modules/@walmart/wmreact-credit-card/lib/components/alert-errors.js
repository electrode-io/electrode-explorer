...
var AlertErrors = function AlertErrors(props) {
  ...
  var AlertComponent = props.alertComponent || _alert2.default;
  return _react2.default.createElement(
    "div",
    { className: className },
    errors.map(function (error, index) {
      return _react2.default.createElement(AlertComponent, (0, _extends3.default)({ key: index }, error, { isBlock: true }, rest));
    })
  );
};
