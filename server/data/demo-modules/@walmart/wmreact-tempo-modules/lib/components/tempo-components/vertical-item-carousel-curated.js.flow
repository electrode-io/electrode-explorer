...
const VerticalItemCarouselCurated = (props) => (
  <TempoTileCarousel className="VerticalItemCarouselCurated" {...props} vertical={true}/>
);
...
export default VerticalItemCarouselCurated;
