...
var WMXOMPAdCarousel = function WMXOMPAdCarousel(props) {
  return _react2.default.createElement(_tempoTileCarousel2.default, (0, _extends3.default)({ className: "WMXOMPAdCarousel" }, props));
};
...
exports.default = WMXOMPAdCarousel;